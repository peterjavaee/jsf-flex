...
public final class MXMLPhoneFormatterRenderer extends MXMLFormatterTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLPhoneFormatterRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_PHONE_FORMATTER_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLPhoneFormatterRendererReplaceMapping.xml";
	}
