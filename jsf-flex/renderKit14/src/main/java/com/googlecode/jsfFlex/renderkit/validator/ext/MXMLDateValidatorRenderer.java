...
public final class MXMLDateValidatorRenderer extends MXMLValidatorTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLDateValidatorRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_DATE_VALIDATOR_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLDateValidatorRendererReplaceMapping.xml";
	}
