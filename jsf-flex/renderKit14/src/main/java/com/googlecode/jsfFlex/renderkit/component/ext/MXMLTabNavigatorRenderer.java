...
public final class MXMLTabNavigatorRenderer extends MXMLViewStackTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLTabNavigatorRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_TAB_NAVIGATOR_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLTabNavigatorRendererReplaceMapping.xml";
	}
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
		...
		writer.mapFields(MXMLTabNavigatorRenderer.class, componentObj, MXML_TAB_NAVIGATOR_REPLACE_MAPPING);
