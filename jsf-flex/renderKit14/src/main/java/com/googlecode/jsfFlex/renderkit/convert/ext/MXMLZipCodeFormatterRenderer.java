...
public final class MXMLZipCodeFormatterRenderer extends MXMLFormatterTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLZipCodeFormatterRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_ZIP_CODE_FORMATTER_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLZipCodeFormatterRendererReplaceMapping.xml";
	}
