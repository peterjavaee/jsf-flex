 ...
 *  type        = "com.googlecode.jsfFlex.MXMLApplicationControlBar"
 * 
 * @JsfFlexAttributes
 * 	dock=false
 * 	fillAlphas=true
...
public final class MXMLApplicationControlBarRenderer extends MXMLBoxTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLApplicationControlBarRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_APPLICATION_CONTROL_BAR_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLApplicationControlBarRendererReplaceMapping.xml";
	}
