...
public final class MXMLRadioButtonRenderer extends MXMLButtonTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLRadioButtonRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_RADIO_BUTTON_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLRadioButtonRendererReplaceMapping.xml";
	}
