...
public final class MXMLEmailValidatorRenderer extends MXMLValidatorTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLEmailValidatorRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_EMAIL_VALIDATOR_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLEmailValidatorRendererReplaceMapping.xml";
	}
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
		...
		writer.mapFields(MXMLEmailValidatorRenderer.class, componentObj, MXML_EMAIL_VALIDATOR_REPLACE_MAPPING);
