...
public final class MXMLXMLListRenderer extends MXMLComponentBaseRenderer {
	...
	private static final String MXML_XML_LIST_REPLACE_MAPPING;
	private static final String MXML_COMPONENT_NAME = "XMLList";
	
	static{
		//TODO : find a better method to implement the below tasks
		String packageName = MXMLXMLListRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_XML_LIST_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLXMLListRendererReplaceMapping.xml";
	}
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
		...
		writer.mapFields(MXMLXMLListRenderer.class, componentObj, MXML_XML_LIST_REPLACE_MAPPING);
