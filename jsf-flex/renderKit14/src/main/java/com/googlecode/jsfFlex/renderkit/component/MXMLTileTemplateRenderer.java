...
public class MXMLTileTemplateRenderer extends MXMLContainerTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLTileTemplateRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_TILE_TEMPLATE_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLTileTemplateRendererReplaceMapping.xml";
	}
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
		...
		writer.mapFields(MXMLTileTemplateRenderer.class, componentObj, MXML_TILE_TEMPLATE_REPLACE_MAPPING);
