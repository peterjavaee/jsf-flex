...
public final class MXMLSocialSecurityValidatorRenderer extends MXMLValidatorTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLSocialSecurityValidatorRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_SOCIAL_SECURITY_VALIDATOR_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLSocialSecurityValidatorRendererReplaceMapping.xml";
	}
