...
public final class MXMLRichTextEditorRenderer extends MXMLPanelTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLRichTextEditorRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_RICH_TEXT_EDITOR_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLRichTextEditorRendererReplaceMapping.xml";
	}
