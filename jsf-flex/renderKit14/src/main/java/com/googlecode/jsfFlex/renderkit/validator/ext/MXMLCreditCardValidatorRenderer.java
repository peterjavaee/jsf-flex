...
public final class MXMLCreditCardValidatorRenderer extends MXMLValidatorTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLCreditCardValidatorRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_CREDIT_CARD_VALIDATOR_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLCreditCardValidatorRendererReplaceMapping.xml";
	}
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
		...
		writer.mapFields(MXMLCreditCardValidatorRenderer.class, componentObj, MXML_CREDIT_CARD_VALIDATOR_REPLACE_MAPPING);
