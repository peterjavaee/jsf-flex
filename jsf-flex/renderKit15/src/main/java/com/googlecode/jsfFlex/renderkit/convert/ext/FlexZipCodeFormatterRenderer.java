...
@FacesRenderer(
		...
		rendererType="com.googlecode.jsfFlex.FlexZipCodeFormatter"
)
...
public final class FlexZipCodeFormatterRenderer extends AbstractFlexComponentBaseRenderer {
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
		...
		writer.createPreMxml(componentFlex, FlexZipCodeFormatterRenderer.class.getAnnotation(IJsfFlexAttributeProperties.class), 
				null);
