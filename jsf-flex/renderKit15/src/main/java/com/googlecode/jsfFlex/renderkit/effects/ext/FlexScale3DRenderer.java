...
@JSFRenderer(
        ...
        type="com.googlecode.jsfFlex.FlexScale3D"
)
@FacesRenderer(
        renderKitId="FLEX_BASIC",
        componentFamily="javax.faces.FlexSimple",
        rendererType="com.googlecode.jsfFlex.FlexScale3D"
)
...
public final class FlexScale3DRenderer extends AbstractFlexComponentRenderer {
    ...
    public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
        ...
        writer.createPreMxml(componentFlex, FlexScale3DRenderer.class.getAnnotation(IJsfFlexAttributeProperties.class), 
                null);
