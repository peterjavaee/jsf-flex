...
@JSFRenderer(
        ...
        type="com.googlecode.jsfFlex.FlexDataProvider"
)
@FacesRenderer(
		renderKitId="FLEX_BASIC",
		componentFamily="javax.faces.FlexSimple",
		rendererType="com.googlecode.jsfFlex.FlexDataProvider"
)
@IJsfFlexAttributeProperties(
		componentName="dataProvider",
        componentNameSpace="s"
)
public final class FlexDataProviderRenderer extends AbstractFlexComponentBaseRenderer {
