...
@FacesRenderer(
		...
		rendererType="com.googlecode.jsfFlex.FlexTileList"
)
...
public final class FlexTileListRenderer extends AbstractFlexComponentRenderer {
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
        ...
        writer.createPreMxml(componentFlex, FlexTileListRenderer.class.getAnnotation(IJsfFlexAttributeProperties.class), 
				null);
