...
public interface _MXMLUIWrongLengthErrorAttribute {
	...
	/**
	 * Error message when the field contains the wrong number of digits for the specified type.
	 * 
	 *@JSFProperty
	 *    required        = false
	 *    rtexprvalue     = false
	 *    desc            = "Error message when the field contains the wrong number of digits for the specified type."
	 */
	String getWrongLengthError();
