 ...
 * @author Ji Hoon Kim
 */
public interface _MXMLUICloseAttributes {
	 ...
	 *    required        = false
	 *    rtexprvalue     = false
	 *    desc            = "Easing function to control component tweening."
	 */
	String getCloseEasingFunction();
	 ...
	 *    required        = false
	 *    rtexprvalue     = false
	 *    desc            = "Length of a close transition, in milliseconds."
	 */
	String getCloseDuration();
