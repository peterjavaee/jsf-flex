 ...
 * @JSFComponent
 *   name     = "jf:mxmlButton"
 *   class    = "com.googlecode.jsfFlex.component.ext.MXMLUIButton"
 *   type     = "com.googlecode.jsfFlex.MXMLUIButton"
 *   tagClass = "com.googlecode.jsfFlex.taglib.ext.MXMLUIButtonTag"
...
public abstract class AbstractMXMLUIButton 
						...
						implements _MXMLUIBaseAttributes, _MXMLUIRepeatAttributes, _MXMLUIIconAttribute,
						...
						_MXMLUIPaddingVerticalAttributes, _MXMLUITextEventColorAttributes, _MXMLUIButtonAttributes, 
						_MXMLUITextAttribute {
	
	private static final String MXML_COMPONENT_RENDERER = "com.googlecode.jsfFlex.MXMLButton";
