...
<f:view renderKitId="MXML_BASIC">
    ...
    <h:form>
    	<jf:mxmlApplication mxmlPackageName="mxmlLocale" height="500" width="800">
    		<jf:mxmlLabel text="Following label contains text to demonstrate locale" color="#FFFFFF" fontWeight="bold"/>
