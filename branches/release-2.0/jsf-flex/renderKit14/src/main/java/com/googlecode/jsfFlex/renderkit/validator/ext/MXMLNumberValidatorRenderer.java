 ...
 * @JsfFlexAttributes
 * 	allowNegative=false
 * 	decimalPointCountError=false
 * 	decimalSeparator=false
 * 	domain=false
 * 	exceedsMaxError=false
 * 	integerError=false
 * 	invalidCharError=false
 * 	invalidFormatCharsError=false
 * 	lowerThanMinError=false
 * 	maxValue=false
 * 	minValue=false
 * 	negativeError=false
 * 	precision=false
 * 	precisionError=false
 * 	separationError=false
...
public final class MXMLNumberValidatorRenderer extends MXMLValidatorTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLNumberValidatorRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_NUMBER_VALIDATOR_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLNumberValidatorRendererReplaceMapping.xml";
	}
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
		...
		writer.mapFields(MXMLNumberValidatorRenderer.class, componentObj, MXML_NUMBER_VALIDATOR_REPLACE_MAPPING);
