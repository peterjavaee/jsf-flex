...
@JSFRenderer(
		...
		type="com.googlecode.jsfFlex.FlexHSlider"
)
...
public final class FlexHSliderRenderer extends AbstractFlexSliderTemplateRenderer {
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
		...
		writer.createPreMxml(componentFlex, FlexHSliderRenderer.class.getAnnotation(IJsfFlexAttributeProperties.class).componentName(), 
				null);
