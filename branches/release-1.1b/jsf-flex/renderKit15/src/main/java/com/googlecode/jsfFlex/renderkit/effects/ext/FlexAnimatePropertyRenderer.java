...
@IJsfFlexAttributeProperties(
        ...
        jsfFlexAttributes={
                ...
                @IJsfFlexAttribute(attribute="fromValue"),
                @IJsfFlexAttribute(attribute="isStyle"),
                @IJsfFlexAttribute(attribute="property"),
                @IJsfFlexAttribute(attribute="roundValue"),
                @IJsfFlexAttribute(attribute="toValue")
        }
)
public final class FlexAnimatePropertyRenderer extends AbstractFlexEffectTemplateRenderer {
