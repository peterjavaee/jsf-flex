...
@FacesRenderer(
        ...
        rendererType="com.googlecode.jsfFlex.FlexSoundEffect"
)
@IJsfFlexAttributeProperties(componentName="SoundEffect")
public final class FlexSoundEffectRenderer extends AbstractFlexComponentRenderer {
