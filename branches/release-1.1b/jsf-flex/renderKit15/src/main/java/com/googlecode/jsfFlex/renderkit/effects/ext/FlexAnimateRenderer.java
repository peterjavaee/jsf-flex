...
@JSFRenderer(
        ...
        type="com.googlecode.jsfFlex.FlexAnimate"
)
@FacesRenderer(
        renderKitId="FLEX_BASIC",
        componentFamily="javax.faces.FlexSimple",
        rendererType="com.googlecode.jsfFlex.FlexAnimate"
)
...
public final class FlexAnimateRenderer extends AbstractFlexComponentRenderer {
    ...
    public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
        ...
        writer.createPreMxml(componentFlex, FlexAnimateRenderer.class.getAnnotation(IJsfFlexAttributeProperties.class), 
                null);
