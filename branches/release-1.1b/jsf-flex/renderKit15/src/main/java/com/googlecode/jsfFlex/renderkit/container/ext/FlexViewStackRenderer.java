...
@JSFRenderer(
        ...
        type="com.googlecode.jsfFlex.FlexViewStack"
)
@FacesRenderer(
		renderKitId="FLEX_BASIC",
		componentFamily="javax.faces.FlexInput",
		rendererType="com.googlecode.jsfFlex.FlexViewStack"
)
...
public final class FlexViewStackRenderer extends AbstractFlexComponentRenderer {
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
        ...
        writer.mapFields(FlexViewStackRenderer.class, componentObj, null);
        writer.createPreMxml(componentFlex, FlexViewStackRenderer.class.getAnnotation(IJsfFlexAttributeProperties.class), 
				null);
