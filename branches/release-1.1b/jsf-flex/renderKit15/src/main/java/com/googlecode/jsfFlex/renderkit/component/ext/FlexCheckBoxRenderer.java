...
@JSFRenderer(
        ...
        type="com.googlecode.jsfFlex.FlexCheckBox"
)
@FacesRenderer(
		renderKitId="FLEX_BASIC",
		componentFamily="javax.faces.FlexInput",
		rendererType="com.googlecode.jsfFlex.FlexCheckBox"
)
...
public final class FlexCheckBoxRenderer extends AbstractFlexComponentRenderer {
