...
@JSFRenderer(
        ...
        type="com.googlecode.jsfFlex.FlexSetStyle"
)
@FacesRenderer(
		renderKitId="FLEX_BASIC",
		componentFamily="javax.faces.FlexSimple",
		rendererType="com.googlecode.jsfFlex.FlexSetStyle"
)
@IJsfFlexAttributeProperties(
		componentName="SetStyle",
...
public final class FlexSetStyleRenderer extends AbstractFlexComponentRenderer {
