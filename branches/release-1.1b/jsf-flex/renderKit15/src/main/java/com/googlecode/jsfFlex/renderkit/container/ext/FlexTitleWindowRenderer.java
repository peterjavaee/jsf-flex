...
@JSFRenderer(
        ...
        type="com.googlecode.jsfFlex.FlexTitleWindow"
)
@FacesRenderer(
		renderKitId="FLEX_BASIC",
		componentFamily="javax.faces.FlexSimple",
		rendererType="com.googlecode.jsfFlex.FlexTitleWindow"
)
@IJsfFlexAttributeProperties(
		componentName="TitleWindow",
        componentNameSpace="s"
)
public final class FlexTitleWindowRenderer extends AbstractFlexComponentRenderer {
