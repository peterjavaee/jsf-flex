...
@IJsfFlexAttributeProperties(
		...
		jsfFlexAttributes={
				@IJsfFlexAttribute(attribute="border"),
				@IJsfFlexAttribute(attribute="horizontalScrollPolicy"),
				@IJsfFlexAttribute(attribute="horizontalScrollPosition"),
				@IJsfFlexAttribute(attribute="liveScrolling"),
				@IJsfFlexAttribute(attribute="maxHorizontalScrollPosition"),
				@IJsfFlexAttribute(attribute="maxVerticalScrollPosition"),
				@IJsfFlexAttribute(attribute="scrollTipFunction"),
				@IJsfFlexAttribute(attribute="showScrollTips"),
...
public abstract class AbstractFlexScrollControlTemplateRenderer extends AbstractFlexComponentRenderer {
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
		...
		writer.mapFields(AbstractFlexScrollControlTemplateRenderer.class, componentObj, null);
