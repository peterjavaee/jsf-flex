...
<f:view renderKitId="FLEX_BASIC">
    ...
    <h:form>
    	...
    	<jf:flexApplication mxmlPackageName="flexAccordion">
    		...
    		<jf:flexAccordion selectedIndex="#{flexOverallBean.accordionSelectedIndex}">
    			...
    			<jf:flexBox>
    				<jf:flexLabel>
    					<jf:flexAttributeNode name="text" value="First container within flexAccordion"/>
    				</jf:flexLabel>
    			</jf:flexBox>
    			<jf:flexBox>
    				<jf:flexLabel>
    					<jf:flexAttributeNode name="text" value="Second container within flexAccordio"/>
    				</jf:flexLabel>
    			</jf:flexBox>
    		</jf:flexAccordion>
    	</jf:flexApplication>
