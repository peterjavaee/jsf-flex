...
<f:view renderKitId="FLEX_BASIC">
    ...
    <h:form>
    	<jf:flexApplication mxmlPackageName="flexLocale" height="500" width="800">
    		<jf:flexLabel text="Following label contains text to demonstrate locale" color="#FFFFFF" fontWeight="bold"/>
