...
import com.googlecode.jsfFlex.attributes._MXMLUIFormatterAttribute;
 ...
 */
@JSFComponent(
        name                =   "jf:mxmlAdvancedDataGridColumn",
        clazz               =   "com.googlecode.jsfFlex.component.ext.MXMLUIAdvancedDataGridColumn",
        type                =   "com.googlecode.jsfFlex.MXMLUIAdvancedDataGridColumn",
        tagClass            =   "com.googlecode.jsfFlex.taglib.ext.MXMLUIAdvancedDataGridColumnTag",
...
public abstract class AbstractMXMLUIAdvancedDataGridColumn 
                        ...
                        _MXMLUIEditorYOffsetAttribute, _MXMLUIFormatterAttribute, _MXMLUIHeaderRendererAttribute, 
                        _MXMLUIHeaderTextAttribute, _MXMLUIHeaderWordWrapAttribute, _MXMLUIImeModeAttribute, 
                        _MXMLUIItemEditorAttribute, _MXMLUIItemRendererAttribute, _MXMLUILabelFunctionAttribute, 
                        _MXMLUIMinWidthAttribute, _MXMLUIRendererIsEditorAttribute, _MXMLUIResizableAttribute, 
                        _MXMLUIShowDataTipsAttribute, _MXMLUISortableAttribute, _MXMLUISortCompareFunctionAttribute, 
                        _MXMLUISortDescendingAttribute, _MXMLUIStyleFunctionAttribute, _MXMLUIVisibleAttribute, 
                        _MXMLUIWidthAttribute, _MXMLUIWordWrapAttribute, _MXMLUIBackgroundColorAttribute, 
                        _MXMLUIColorAttribute, _MXMLUIDisabledColorAttribute, _MXMLUIFontAntiAliasTypeAttribute, 
                        _MXMLUIFontFamilyAttribute, _MXMLUIFontGridFitTypeAttribute, _MXMLUIFontSharpnessAttribute, 
                        _MXMLUIFontSizeAttribute, _MXMLUIFontStyleAttribute, _MXMLUIFontThicknessAttribute, 
