...
@JsfFlexAttributeProperties(
        ...
        jsfFlexAttributes={
                ...
                @JsfFlexAttribute(attribute="dataChangeEffect"),
...
public abstract class MXMLAdvancedListBaseTemplateRenderer extends MXMLScrollControlTemplateRenderer {
    ...
    public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
        ...
        writer.mapFields(MXMLAdvancedListBaseTemplateRenderer.class, componentObj, null);
