...
@JsfFlexAttributeProperties(
        ...
        jsfFlexAttributes={
                ...
                @JsfFlexAttribute(attribute="lookAheadDuration"),
                ...
                @JsfFlexAttribute(attribute="headerBackgroundSkin"),
...
public abstract class MXMLAdvancedDataGridBaseExTemplateRenderer extends MXMLAdvancedDataGridBaseTemplateRenderer {
    ...
    public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
        ...
        writer.mapFields(MXMLAdvancedDataGridBaseExTemplateRenderer.class, componentObj, null);
