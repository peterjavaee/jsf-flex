...
public final class MXMLTitleWindowRenderer extends MXMLPanelTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLTitleWindowRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_TITLE_WINDOW_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLTitleWindowRendererReplaceMapping.xml";
	}
