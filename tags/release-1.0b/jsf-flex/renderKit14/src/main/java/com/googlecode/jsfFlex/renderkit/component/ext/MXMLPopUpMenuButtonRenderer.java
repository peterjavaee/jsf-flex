...
public final class MXMLPopUpMenuButtonRenderer extends MXMLPopUpButtonTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLPopUpMenuButtonRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_POP_UP_MENU_BUTTON_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLPopUpMenuButtonRendererReplaceMapping.xml";
	}
