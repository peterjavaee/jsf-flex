...
@JsfFlexAttributeProperties(
		mxmlComponentName="RemoteObject",
...
public final class MXMLRemoteObjectRenderer extends MXMLComponentBaseRenderer {
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
		...
		writer.mapFields(MXMLRemoteObjectRenderer.class, componentObj, null);
		writer.createPreMxml(componentMXML, MXMLRemoteObjectRenderer.class.getAnnotation(JsfFlexAttributeProperties.class).mxmlComponentName(), 
				null);
