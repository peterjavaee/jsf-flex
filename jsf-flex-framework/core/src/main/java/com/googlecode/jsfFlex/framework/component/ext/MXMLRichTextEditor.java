...
public class MXMLRichTextEditor extends MXMLPanelTemplate {
	...
	private static final String MXML_RICH_TEXT_EDITOR_TEMPLATE;
	...
	static{
		...
		MXML_RICH_TEXT_EDITOR_TEMPLATE = packageName + "/templates/MXMLRichTextEditor.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_RICH_TEXT_EDITOR_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_RICH_TEXT_EDITOR_TEMPLATE);
