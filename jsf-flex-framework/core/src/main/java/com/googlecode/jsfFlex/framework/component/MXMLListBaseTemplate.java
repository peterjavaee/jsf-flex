...
public class MXMLListBaseTemplate extends MXMLScrollControlTemplate {
	...
	private static final String MXML_LIST_BASE_TEMPLATE_CONTENT_TOKEN = "&listBase;";
	private static final String MXML_LIST_BASE_TEMPLATE_TEMPLATE;
	...
	static{
		...
		MXML_LIST_BASE_TEMPLATE_TEMPLATE = packageName + "/templates/MXMLListBaseTemplate.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException {
		...
		mapFields(componentObj, MXML_LIST_BASE_TEMPLATE_REPLACE_MAPPING);
	...
	public void buildComponentInterlude(Object componentObj) throws ComponentBuildException{
		...
		addInsertComponentTemplateTask(componentMXML, MXML_LIST_BASE_TEMPLATE_CONTENT_TOKEN, 
											getComponentTemplate(MXML_LIST_BASE_TEMPLATE_TEMPLATE));
