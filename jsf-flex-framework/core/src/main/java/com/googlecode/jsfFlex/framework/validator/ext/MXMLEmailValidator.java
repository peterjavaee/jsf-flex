...
public class MXMLEmailValidator extends MXMLValidatorTemplate {
	...
	private static final String MXML_EMAIL_VALIDATOR_TEMPLATE;
	...
	static{
		...
		MXML_EMAIL_VALIDATOR_TEMPLATE = packageName + "/templates/MXMLEmailValidator.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_EMAIL_VALIDATOR_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_EMAIL_VALIDATOR_TEMPLATE);
