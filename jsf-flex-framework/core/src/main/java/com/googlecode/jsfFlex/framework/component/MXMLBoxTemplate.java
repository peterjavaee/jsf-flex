...
public abstract class MXMLBoxTemplate extends MXMLContainerTemplate {
	...
	private static final String MXML_BOX_TEMPLATE_CONTENT_TOKEN = "&box;";
	private static final String MXML_BOX_TEMPLATE_TEMPLATE;
	...
	static{
		...
		MXML_BOX_TEMPLATE_TEMPLATE = packageName + "/templates/MXMLBoxTemplate.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_BOX_TEMPLATE_REPLACE_MAPPING);
	...
	public void buildComponentInterlude(Object componentObj) throws ComponentBuildException{
		...
		addInsertComponentTemplateTask(componentMXML, MXML_BOX_TEMPLATE_CONTENT_TOKEN, 
											getComponentTemplate(MXML_BOX_TEMPLATE_TEMPLATE));
