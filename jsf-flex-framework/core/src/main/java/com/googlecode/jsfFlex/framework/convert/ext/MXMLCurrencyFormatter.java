...
public class MXMLCurrencyFormatter extends MXMLFormatterTemplate {
	...
	private static final String MXML_CURRENCY_FORMATTER_TEMPLATE;
	...
	static{
		...
		MXML_CURRENCY_FORMATTER_TEMPLATE = packageName + "/templates/MXMLCurrencyFormatter.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_CURRENCY_FORMATTER_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_CURRENCY_FORMATTER_TEMPLATE);
