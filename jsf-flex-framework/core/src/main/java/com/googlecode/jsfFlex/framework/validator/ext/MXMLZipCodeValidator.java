...
public class MXMLZipCodeValidator extends MXMLValidatorTemplate {
	...
	private static final String MXML_ZIP_CODE_VALIDATOR_TEMPLATE;
	...
	static{
		...
		MXML_ZIP_CODE_VALIDATOR_TEMPLATE = packageName + "/templates/MXMLZipCodeValidator.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_ZIP_CODE_VALIDATOR_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_ZIP_CODE_VALIDATOR_TEMPLATE);
