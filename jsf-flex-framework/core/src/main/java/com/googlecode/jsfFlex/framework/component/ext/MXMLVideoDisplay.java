...
public class MXMLVideoDisplay extends MXMLComponentBase {
	...
	private static final String MXML_VIDEO_DISPLAY_TEMPLATE;
	...
	static{
		...
		MXML_VIDEO_DISPLAY_TEMPLATE = packageName + "/templates/MXMLVideoDisplay.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_VIDEO_DISPLAY_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_VIDEO_DISPLAY_TEMPLATE);
