...
public class MXMLDateValidator extends MXMLValidatorTemplate {
	...
	private static final String MXML_DATE_VALIDATOR_TEMPLATE;
	...
	static{
		...
		MXML_DATE_VALIDATOR_TEMPLATE = packageName + "/templates/MXMLDateValidator.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_DATE_VALIDATOR_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_DATE_VALIDATOR_TEMPLATE);
