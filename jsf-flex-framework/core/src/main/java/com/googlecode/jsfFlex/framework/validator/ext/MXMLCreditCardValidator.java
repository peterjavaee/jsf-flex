...
public class MXMLCreditCardValidator extends MXMLValidatorTemplate {
	...
	private static final String MXML_CREDIT_CARD_VALIDATOR_TEMPLATE;
	...
	static{
		...
		MXML_CREDIT_CARD_VALIDATOR_TEMPLATE = packageName + "/templates/MXMLCreditCardValidator.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_CREDIT_CARD_VALIDATOR_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_CREDIT_CARD_VALIDATOR_TEMPLATE);
