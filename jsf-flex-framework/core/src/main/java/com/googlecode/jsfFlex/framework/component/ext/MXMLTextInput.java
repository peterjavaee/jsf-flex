...
public class MXMLTextInput extends MXMLComponentBase {
	...
	private static final String MXML_TEXT_INPUT_TEMPLATE;
	...
	static{
		...
		MXML_TEXT_INPUT_TEMPLATE = packageName + "/templates/MXMLTextInput.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_TEXT_INPUT_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_TEXT_INPUT_TEMPLATE);
