...
public class MXMLProgressBar extends MXMLComponentBase {
	...
	private static final String MXML_PROGRESS_BAR_TEMPLATE;
	...
	static{
		...
		MXML_PROGRESS_BAR_TEMPLATE = packageName + "/templates/MXMLProgressBar.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_PROGRESS_BAR_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_PROGRESS_BAR_TEMPLATE);
