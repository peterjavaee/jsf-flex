...
public class MXMLTabNavigator extends MXMLViewStackTemplate {
	...
	private static final String MXML_TAB_NAVIGATOR_TEMPLATE;
	...
	static{
		...
		MXML_TAB_NAVIGATOR_TEMPLATE = packageName + "/templates/MXMLTabNavigator.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_TAB_NAVIGATOR_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_TAB_NAVIGATOR_TEMPLATE);
