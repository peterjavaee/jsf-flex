...
public abstract class MXMLContainerTemplate extends MXMLComponentBase {
	...
	private static final String MXML_CONTAINER_TEMPLATE_CONTENT_TOKEN = "&container;";
	private static final String MXML_CONTAINER_TEMPLATE_TEMPLATE;
	...
	static{
		...
		MXML_CONTAINER_TEMPLATE_TEMPLATE = packageName + "/templates/MXMLContainerTemplate.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException {
		...
		mapFields(componentObj, MXML_CONTAINER_TEMPLATE_REPLACE_MAPPING);
	...
	public void buildComponentInterlude(Object componentObj) throws ComponentBuildException{
		...
		addInsertComponentTemplateTask(componentMXML, MXML_CONTAINER_TEMPLATE_CONTENT_TOKEN, 
											getComponentTemplate(MXML_CONTAINER_TEMPLATE_TEMPLATE));
