 ...
 * @author Ji Hoon Kim
 */
public class MXMLC extends Ant_Base implements _Task {
	...
	public MXMLC(String file, String output_path, _MXMLApplicationContract componentMXML, String flexSDKRootPath){
		_file = file;
	...
	public boolean equals(Object obj) {
		if(!(obj instanceof MXMLC)){
			return false;
		}
		
		MXMLC mxmlcInstance = (MXMLC) obj;
		return (this.getFile().equals(mxmlcInstance.getFile()));
	}
