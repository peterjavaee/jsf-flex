...
public abstract class MXMLComboBaseTemplate extends MXMLComponentBase {
	...
	private static final String MXML_COMBO_BASE_TEMPLATE_CONTENT_TOKEN = "&comboBase;";
	private static final String MXML_COMBO_BASE_TEMPLATE_TEMPLATE;
	...
	static{
		...
		MXML_COMBO_BASE_TEMPLATE_TEMPLATE = packageName + "/templates/MXMLComboBaseTemplate.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException {
		...
		mapFields(componentObj, MXML_COMBO_BASE_TEMPLATE_REPLACE_MAPPING);
	...
	public void buildComponentInterlude(Object componentObj) throws ComponentBuildException{
		...
		addInsertComponentTemplateTask(componentMXML, MXML_COMBO_BASE_TEMPLATE_CONTENT_TOKEN, 
											getComponentTemplate(MXML_COMBO_BASE_TEMPLATE_TEMPLATE));
