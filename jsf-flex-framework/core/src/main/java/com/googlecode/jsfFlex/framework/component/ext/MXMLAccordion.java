...
public class MXMLAccordion extends MXMLContainerTemplate {
	...
	private static final String MXML_ACCORDION_TEMPLATE;
	...
	static{
		...
		MXML_ACCORDION_TEMPLATE = packageName + "/templates/MXMLAccordion.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_ACCORDION_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_ACCORDION_TEMPLATE);
