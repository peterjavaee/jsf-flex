...
public final class MXMLNumberFormatter extends MXMLFormatterTemplate {
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(MXMLNumberFormatter.class, componentObj, null);
	...
	public void buildComponentInterlude(Object componentObj) throws ComponentBuildException {
		...
		addCreatePreMxmlTask(componentMXML, MXMLNumberFormatter.class.getAnnotation(JsfFlexAttributeProperties.class).componentName(), 
								null);
