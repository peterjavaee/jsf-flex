...
public class MXMLStringValidator extends MXMLValidatorTemplate {
	...
	private static final String MXML_STRING_VALIDATOR_TEMPLATE;
	...
	static{
		...
		MXML_STRING_VALIDATOR_TEMPLATE = packageName + "/templates/MXMLStringValidator.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_STRING_VALIDATOR_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_STRING_VALIDATOR_TEMPLATE);
