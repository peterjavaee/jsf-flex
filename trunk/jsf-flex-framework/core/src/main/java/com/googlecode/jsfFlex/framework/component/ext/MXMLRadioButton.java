...
public class MXMLRadioButton extends MXMLButtonTemplate {
	...
	private static final String MXML_RADIO_BUTTON_TEMPLATE;
	...
	static{
		...
		MXML_RADIO_BUTTON_TEMPLATE = packageName + "/templates/MXMLRadioButton.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_RADIO_BUTTON_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_RADIO_BUTTON_TEMPLATE);
