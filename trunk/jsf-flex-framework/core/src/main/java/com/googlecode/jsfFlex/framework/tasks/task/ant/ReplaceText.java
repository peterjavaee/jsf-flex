 ...
 * @author Ji Hoon Kim
 */
public class ReplaceText extends Ant_Base implements _Task {
	...
	public boolean equals(Object obj) {
		...
		ReplaceText replaceTextInstance = (ReplaceText) obj;
		return (this.getFile().equals(replaceTextInstance.getFile()) && this.getReplaceList().size() == replaceTextInstance.getReplaceList().size());
	}
