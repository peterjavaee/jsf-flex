...
public class MXMLDateField extends MXMLComboBaseTemplate {
	...
	private static final String MXML_DATE_FIELD_TEMPLATE;
	...
	static{
		...
		MXML_DATE_FIELD_TEMPLATE = packageName + "/templates/MXMLDateField.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_DATE_FIELD_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_DATE_FIELD_TEMPLATE);
