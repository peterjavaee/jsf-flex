...
public class MXMLColorPicker extends MXMLComboBaseTemplate {
	...
	private static final String MXML_COLOR_PICKER_TEMPLATE;
	...
	static{
		...
		MXML_COLOR_PICKER_TEMPLATE = packageName + "/templates/MXMLColorPicker.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_COLOR_PICKER_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_COLOR_PICKER_TEMPLATE);
