 ...
 * @author Ji Hoon Kim
 */
public class MXMLTitleWindow extends MXMLPanelTemplate {
	
	private static final String MXML_TITLE_WINDOW_TEMPLATE;
	...
	static{
		...
		MXML_TITLE_WINDOW_TEMPLATE = packageName + "/templates/MXMLTitleWindow.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_TITLE_WINDOW_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_TITLE_WINDOW_TEMPLATE);
