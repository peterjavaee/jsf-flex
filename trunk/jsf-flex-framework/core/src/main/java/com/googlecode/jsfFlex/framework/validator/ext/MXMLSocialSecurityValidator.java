...
public class MXMLSocialSecurityValidator extends MXMLValidatorTemplate {
	...
	private static final String MXML_SOCIAL_SECURITY_VALIDATOR_TEMPLATE;
	...
	static{
		...
		MXML_SOCIAL_SECURITY_VALIDATOR_TEMPLATE = packageName + "/templates/MXMLSocialSecurityValidator.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_SOCIAL_SECURITY_VALIDATOR_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_SOCIAL_SECURITY_VALIDATOR_TEMPLATE);
