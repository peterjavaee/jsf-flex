...
public abstract class MXMLPopUpButtonTemplate extends MXMLButtonTemplate {
	...
	private static final String MXML_POP_UP_BUTTON_TEMPLATE_CONTENT_TOKEN = "&popUpbutton;";
	private static final String MXML_POP_UP_BUTTON_TEMPLATE_TEMPLATE;
	...
	static{
		...
		MXML_POP_UP_BUTTON_TEMPLATE_TEMPLATE = packageName + "/templates/MXMLPopUpButtonTemplate.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_POP_UP_BUTTON_TEMPLATE_REPLACE_MAPPING);
	...
	public void buildComponentInterlude(Object componentObj) throws ComponentBuildException{
		...
		addInsertComponentTemplateTask(componentMXML, MXML_POP_UP_BUTTON_TEMPLATE_CONTENT_TOKEN, 
											getComponentTemplate(MXML_POP_UP_BUTTON_TEMPLATE_TEMPLATE));
