...
public class MXMLComboBox extends MXMLComboBaseTemplate {
	...
	private static final String MXML_COMBO_BOX_TEMPLATE;
	...
	static{
		...
		MXML_COMBO_BOX_TEMPLATE = packageName + "/templates/MXMLComboBox.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_COMBO_BOX_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_COMBO_BOX_TEMPLATE);
