...
public class MXMLScrollBarTemplate extends MXMLComponentBase {
	...
	private static final String MXML_SCROLL_BAR_TEMPLATE_CONTENT_TOKEN = "&scrollBar;";
	private static final String MXML_SCROLL_BAR_TEMPLATE_TEMPLATE;
	...
	static{
		...
		MXML_SCROLL_BAR_TEMPLATE_TEMPLATE = packageName + "/templates/MXMLScrollBarTemplate.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException {
		...
		mapFields(componentObj, MXML_SCROLL_BAR_TEMPLATE_REPLACE_MAPPING);
	...
	public void buildComponentInterlude(Object componentObj) throws ComponentBuildException{
		...
		addInsertComponentTemplateTask(componentMXML, MXML_SCROLL_BAR_TEMPLATE_CONTENT_TOKEN, 
											getComponentTemplate(MXML_SCROLL_BAR_TEMPLATE_TEMPLATE));
