...
public abstract class MXMLLabelTemplate extends MXMLComponentBase {
	...
	private static final String MXML_LABEL_TEMPLATE_CONTENT_TOKEN = "&label;";
	private static final String MXML_LABEL_TEMPLATE_TEMPLATE;
	...
	static{
		...
		MXML_LABEL_TEMPLATE_TEMPLATE = packageName + "/templates/MXMLLabelTemplate.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_LABEL_TEMPLATE_REPLACE_MAPPING);
	...
	public void buildComponentInterlude(Object componentObj) throws ComponentBuildException{
		...
		addInsertComponentTemplateTask(componentMXML, MXML_LABEL_TEMPLATE_CONTENT_TOKEN, 
											getComponentTemplate(MXML_LABEL_TEMPLATE_TEMPLATE));
