...
public class MXMLMenuBar extends MXMLComponentBase {
	...
	private static final String MXML_MENU_BAR_TEMPLATE;
	...
	static{
		...
		MXML_MENU_BAR_TEMPLATE = packageName + "/templates/MXMLMenuBar.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_MENU_BAR_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_MENU_BAR_TEMPLATE);
