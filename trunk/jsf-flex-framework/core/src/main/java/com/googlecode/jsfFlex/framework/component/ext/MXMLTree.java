...
public class MXMLTree extends MXMLListTemplate {
	...
	private static final String MXML_TREE_TEMPLATE;
	...
	static{
		...
		MXML_TREE_TEMPLATE = packageName + "/templates/MXMLTree.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_TREE_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_TREE_TEMPLATE);
