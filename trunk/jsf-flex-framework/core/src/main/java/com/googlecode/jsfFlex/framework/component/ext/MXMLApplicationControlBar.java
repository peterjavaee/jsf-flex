...
public class MXMLApplicationControlBar extends MXMLBoxTemplate {
	...
	private static final String MXML_APPLICATION_CONTROL_BAR_TEMPLATE;
	...
	static{
		...
		MXML_APPLICATION_CONTROL_BAR_TEMPLATE = packageName + "/templates/MXMLApplicationControlBar.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_APPLICATION_CONTROL_BAR_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_APPLICATION_CONTROL_BAR_TEMPLATE);
