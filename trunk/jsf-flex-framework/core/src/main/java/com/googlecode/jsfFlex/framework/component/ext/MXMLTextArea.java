...
public class MXMLTextArea extends MXMLScrollControlTemplate {
	...
	private static final String MXML_TEXT_AREA_TEMPLATE;
	...
	static{
		...
		MXML_TEXT_AREA_TEMPLATE = packageName + "/templates/MXMLTextArea.template";
	}
	...
	public void buildComponentBegin(Object componentObj) throws ComponentBuildException{
		...
		mapFields(componentObj, MXML_TEXT_AREA_REPLACE_MAPPING);
		addCreatePreMxmlTask(componentMXML, MXML_TEXT_AREA_TEMPLATE);
