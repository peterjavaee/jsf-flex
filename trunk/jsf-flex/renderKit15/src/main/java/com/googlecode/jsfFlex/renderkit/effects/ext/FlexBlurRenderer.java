...
@JSFRenderer(
        ...
        type="com.googlecode.jsfFlex.FlexBlur"
)
@FacesRenderer(
        renderKitId="FLEX_BASIC",
        componentFamily="javax.faces.FlexSimple",
        rendererType="com.googlecode.jsfFlex.FlexBlur"
)
@IJsfFlexAttributeProperties(componentName="Blur")
public final class FlexBlurRenderer extends AbstractFlexComponentRenderer {
