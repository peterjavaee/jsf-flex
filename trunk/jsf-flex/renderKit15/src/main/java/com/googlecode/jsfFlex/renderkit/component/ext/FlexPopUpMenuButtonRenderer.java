...
@FacesRenderer(
		...
		rendererType="com.googlecode.jsfFlex.FlexPopUpMenuButton"
)
@IJsfFlexAttributeProperties(componentName="PopUpMenuButton")
public final class FlexPopUpMenuButtonRenderer extends AbstractFlexComponentRenderer {
