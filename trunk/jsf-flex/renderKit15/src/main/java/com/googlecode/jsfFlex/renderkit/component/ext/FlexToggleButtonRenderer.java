...
@JSFRenderer(
        ...
        type="com.googlecode.jsfFlex.FlexToggleButton"
)
@FacesRenderer(
        renderKitId="FLEX_BASIC",
        componentFamily="javax.faces.FlexInput",
        rendererType="com.googlecode.jsfFlex.FlexToggleButton"
)
...
public final class FlexToggleButtonRenderer extends AbstractFlexComponentRenderer {
    ...
    public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
        ...
        writer.createPreMxml(componentFlex, FlexToggleButtonRenderer.class.getAnnotation(IJsfFlexAttributeProperties.class), 
                null);
