...
@FacesRenderer(
		...
		rendererType="com.googlecode.jsfFlex.FlexImage"
)
@IJsfFlexAttributeProperties(componentName="Image")
public final class FlexImageRenderer extends AbstractFlexComponentRenderer {
