...
@FacesRenderer(
        ...
        rendererType="com.googlecode.jsfFlex.FlexWipeUp"
)
@IJsfFlexAttributeProperties(componentName="WipeUp")
public final class FlexWipeUpRenderer extends AbstractFlexComponentRenderer {
