...
public final class MXMLStringValidatorRenderer extends MXMLValidatorTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLStringValidatorRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_STRING_VALIDATOR_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLStringValidatorRendererReplaceMapping.xml";
	}
	...
	public void encodeBegin(FacesContext context, UIComponent componentObj) throws IOException {
		...
		writer.mapFields(MXMLStringValidatorRenderer.class, componentObj, MXML_STRING_VALIDATOR_REPLACE_MAPPING);
