 ...
 * @author Ji Hoon Kim
 */
public final class MXMLHScrollBarRenderer extends MXMLScrollBarTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLHScrollBarRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_HSCROLL_BAR_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLHScrollBarRendererReplaceMapping.xml";
	}
