...
public final class MXMLCurrencyValidatorRenderer extends MXMLValidatorTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLCurrencyValidatorRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_CURRENCY_VALIDATOR_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLCurrencyValidatorRendererReplaceMapping.xml";
	}
