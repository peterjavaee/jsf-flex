 ...
 *  type        = "com.googlecode.jsfFlex.MXMLRemoveChild"
 * 
 * @JsfFlexAttributes
 *  id=true
 * 	target=false
...
public final class MXMLRemoveChildRenderer extends MXMLComponentBaseRenderer {
	...
	private static final String MXML_REMOVE_CHILD_REPLACE_MAPPING;
	private static final String MXML_COMPONENT_NAME = "RemoveChild";
	
	static{
		//TODO : find a better method to implement the below tasks
		String packageName = MXMLRemoveChildRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_REMOVE_CHILD_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLRemoveChildRendererReplaceMapping.xml";
	}
