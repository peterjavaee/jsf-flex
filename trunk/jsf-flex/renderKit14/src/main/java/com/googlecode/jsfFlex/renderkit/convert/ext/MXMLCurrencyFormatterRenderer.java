...
public final class MXMLCurrencyFormatterRenderer extends MXMLFormatterTemplateRenderer {
	...
	static{
		...
		String packageName = MXMLCurrencyFormatterRenderer.class.getPackage().getName();
		packageName = packageName.replace('.', '/');
		MXML_CURRENCY_FORMATTER_REPLACE_MAPPING = packageName + "/replaceMapping/MXMLCurrencyFormatterRendererReplaceMapping.xml";
	}
