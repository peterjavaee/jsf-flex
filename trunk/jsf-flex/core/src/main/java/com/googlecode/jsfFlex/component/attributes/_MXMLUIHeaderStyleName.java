 ...
 * @author Ji Hoon Kim
 */
public interface _MXMLUIHeaderStyleName {
	 ...
	 *    required        = false
	 *    rtexprvalue     = false
	 *    desc            = "Name of the style sheet definition to configure the text (month name and year) and appearance of the header area of the control."
	 */
