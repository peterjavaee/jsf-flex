 ...
 * under the License.
 */
package com.googlecode.jsfFlex.convert.attributes;
 ...
 * @author Ji Hoon Kim
 */
public interface _MXMLUICurrencyAttributes {
	 ...
	 *    required        = false
	 *    rtexprvalue     = false
	 *    desc            = "Aligns currency symbol to the left side or the right side of the formatted number."
	 */
	String getAlignSymbol();
	 ...
	 *    required        = false
	 *    rtexprvalue     = false
	 *    desc            = "Character to use as a currency symbol for a formatted number."
	 */
