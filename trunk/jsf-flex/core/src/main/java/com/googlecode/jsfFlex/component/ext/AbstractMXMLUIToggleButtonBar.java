...
public abstract class AbstractMXMLUIToggleButtonBar 
						...
						implements _MXMLUISelectedButtonTextStyleNameAttribute, _MXMLUIButtonBarAttributes, 
						...
						_MXMLUIDisabledColorAttribute, _MXMLUIFocusAlphaAttribute, _MXMLUIFocusRoundedCornersAttribute, 
						...
						_MXMLUITrackAttributes, _MXMLUIVerticalAlignAttribute, _MXMLUIToggleOnClickAttribute {
	
	private static final String MXML_COMPONENT_RENDERER = "com.googlecode.jsfFlex.MXMLToggleButtonBar";
