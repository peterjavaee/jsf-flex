...
public class Messages extends NLS {
	...
	public static String ACCESSING_THE_HTML_AT;
	...
	public static String PARSE_PACKAGE_HTML_CONTENT;
	public static String PARSING;
	public static String PARSING_OF_TOP_AS_CLASS;
	public static String PARSING_THE_SUCCESSFULLY_RETRIEVED_HTML_CONTENT;
	public static String STARTING_THE_AS_PARSING_PROCESS;
	public static String STARTING_THE_PARSE_OF_AS_CLASS;
	public static String STARTING_THE_PARSING_OF_PACKAGE_HTML_CONTENT;
